from appengine import ModInstallerClient
import skyrim_mods
...
def run_skyrim_install():
    ...
    # TODO: Verify inventory failure is caused by below mods by running install up to this point and opening inventory.
    # Pass 3
    # mods = [
